...
static const char qt_meta_stringdata_KQOAuthRequest[] = {
    "KQOAuthRequest\0"
};

const QMetaObject KQOAuthRequest::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_KQOAuthRequest,
      qt_meta_data_KQOAuthRequest, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &KQOAuthRequest::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_KQOAuthRequest))
